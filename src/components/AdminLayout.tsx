        ...
        {(isMobileMenuOpen || !isMobile) && (
          <>
            ...
            <motion.aside 
              ...
              className={`fixed lg:sticky left-0 top-0 h-screen bg-card border-r border-border-color z-[80] flex flex-col ${isMobile ? 'shadow-2xl' : ''}`}
            >
              {/* Logo Area */}
                  ...
                  return (
                    <div key={item.path} className="relative group">
                      ...
                      >
                        ...
                        {!isSidebarOpen && !isMobile && hoveredItem === item.path && (
              ...
              {!isMobile && (
                <button 
                  ...
                  className="absolute -right-3 top-10 w-6 h-6 bg-card border border-border-color rounded-full items-center justify-center text-text-muted hover:text-superior transition-all shadow-sm z-[60]"
                >
